---
name: perf-audit
description: Systematic performance audit of a slow screen or per-frame loop. Use when the user reports a laggy screen, high memory, frame drops, or asks to optimize the capture/analysis loop. Baseline measurement first, then main-thread, rendering, and memory analysis.
---
