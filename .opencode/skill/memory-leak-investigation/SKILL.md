...
description: Investigate Android memory leaks from LeakCanary traces, heap dumps, retained-object reports, or code. Use when the user reports a memory leak, growing RSS, or OOM on a device, or the overlay process grows. Traces the strong-reference path to the retaining owner.
---
