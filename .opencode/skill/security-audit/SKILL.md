---
name: security-audit
description: Complete mobile app security audit across code, configuration, storage, networking, permissions, build settings, and release readiness. Use when the user wants a full OWASP-based pre-release review.
---
