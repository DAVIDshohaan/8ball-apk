---
name: crash-triage
description: Rapid mobile crash triage from a pasted stacktrace, logcat fatal, or ApplicationExitInfo. Use when a crash alert fires, the user pastes a stacktrace, or asks what caused this crash. Classifies type, finds the root cause, and gives the fix.
---
