...
description: Strict clean-code and architecture audit for a mobile app or feature. Use before merge, during refactors, or to review file organization, model separation, and dependency boundaries across the codebase.
---
